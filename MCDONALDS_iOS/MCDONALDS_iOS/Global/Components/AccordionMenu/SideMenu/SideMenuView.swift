//
//  SideMenuCardView.swift
//  MCDONALDS_iOS
//
//  Created by 이상엽 on 5/17/25.
//
...
final class SideMenuView: UIView {
    ...
    private let expandedSideMenuView = ExpandedSideMenuView()
    
    private let hiddenSeparatorView = UIView()

    private let expandedEAView = ExpandedEAView()
    ...
    private func setUI() {
        ...
        expandedSideMenuView.isHidden = true
        hiddenSeparatorView.isHidden = true
        expandedEAView.isHidden = true
    ...
    private func setLayout() {
        ...
        expandedSideMenuView.snp.makeConstraints{
        ...
        hiddenSeparatorView.snp.makeConstraints{
            $0.height.equalTo(1)
            $0.top.equalTo(expandedSideMenuView.snp.bottom)
            $0.horizontalEdges.equalTo(containerView.snp.horizontalEdges)
        }
        
        changeIngredientsLabel.snp.makeConstraints{
            $0.leading.equalTo(containerView.snp.leading).offset(24)
            $0.top.equalTo(expandedSideMenuView.snp.bottom).offset(10)
        }
        ...
        expandedEAView.snp.makeConstraints{
    ...
    private func expandMenu() {
        ...
        expandedSideMenuView.isHidden = !isSideExpanded
        hiddenSeparatorView.isHidden = !isSideExpanded

        expandedSideMenuHeight?.update(offset: isSideExpanded ? 48 : 0)
    ...
    private func expandEASection() {
        ...
        expandedEAView.isHidden = !isEAExpanded
